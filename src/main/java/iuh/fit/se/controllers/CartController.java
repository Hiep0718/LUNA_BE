...
public class CartController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addToCart(@RequestParam int productId, @RequestParam int quantity, HttpSession session) {
    ...
    @PutMapping("/update")
    public ResponseEntity<CartDTO> updateCart(@RequestParam int productId, @RequestParam int quantity, HttpSession session) {
        CartDTO cart = getCart(session);
    ...
    public ResponseEntity<CartDTO> removeFromCart(@RequestParam int productId, HttpSession session) {
        CartDTO cart = getCart(session);
